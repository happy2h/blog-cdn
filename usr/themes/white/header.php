...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/happy2h/index-component/font-awesome.css" type="text/css">
 ...
 <meta name="viewport" content="initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=0, width=device-width"/>
	...
	<style>
	    ...
	    @font-face {
        font-family: jiangxizuokai;
        src:url(https://cdn.jsdelivr.net/gh/happy2h/index-component@1.2/jiangxizuokai.ttf)
        /*src:url(https://blogcdn.nickxie.top/font/jiangxizuokai.ttf)*/
        /*font-family: xihe_OldStyle;*/
        
        /*src:url(https://cdn.jsdelivr.net/gh/happy2h/index-component@1.4/xihe_OldStyle.otf)*/
        
       }
       
       @font-face {
        font-family: FZSSJW;
        src:url(https://cdn.jsdelivr.net/gh/happy2h/index-component@1.5/FZSSJW.TTF);
        /*src:url(https://blogcdn.nickxie.top/font/FZSSJW.TTF);*/
       }
			...
			<div id="header-container">
				...
				<div id="header-text">
                    <a href="<?php Helper::options()->siteUrl()?>">
                        ...
                        <span id="header-text-span"><?php $this->options->description() ?></span>
